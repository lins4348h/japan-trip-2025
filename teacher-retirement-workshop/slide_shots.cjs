...
const REGIONS = [
  ...
  ['p3-result', 2, '你的收支體檢', '沒記帳？', 'kids'],
  ['p3-gap', 2, '今天最重要的一個數字', '今天最重要的一個數字', 'kids'],
  ['p4-input', 3, 'HANDS-ON 04', '你的負債', 'kids'],
  ['p4-result', 3, '你的資產總覽', '房屋淨值', 'kids'],
  ['p4-ratio', 3, '負債比', '淨值 ≠ 可以拿去理財的錢', 'kids'],
  ...
  ['p7-think', 6, '72 法則：幾年翻倍', '想一想', 'kids'],
