...
每個城市拆成兩張（-1 景點與交通、-2 美食與行程），共六張：

| 檔案 | 城市 | 主色 |
| --- | --- | --- |
| `01-bangkok-1/-2` | 曼谷 Bangkok | 朱紅 × 廟宇金 |
| `02-chiangmai-1/-2` | 清邁 Chiang Mai | 森林綠 × 柚木棕 |
| `03-hanoi-1/-2` | 河內 Hanoi | 湖水藍 × 芥末黃 |

- 版面寬 1080 px（輸出 2160 px，2 倍解析度），手機全寬檢視時內文約 10 pt，不用放大就看得到
- 第 1 張：6 格基本資訊、6 個景點（分三區）、3 條交通
- 第 2 張：5 項美食、4 則行前提醒、4 天行程、預算表
- 單張約 1080×2800 px，手機滑兩下看完一張
